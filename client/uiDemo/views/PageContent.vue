    ...
    <div class="main">
      ...
      <div class="PageContentWrapper VLayout align-center">
        <div class="PageContentHeader VLayout">
          <span class="category">{{pageContent.category || "Category"}}</span>
          <span class="displayName">{{pageContent.displayName || "Welcome"}}</span>
        </div>

        <div class="PageContentNav HLayout">
          <div class="NavBlock" v-for="navObj of navLinks" :key="navObj.name">
            <Button
              size="large"
              btnStyle="dark"
              :value="navObj.name"
        ...
        <div class="PageContentFooter">
          <div class="HLayout">
            <Link value="Github" href="https://github.com/enw860/vueApp" />
            <DisplayText value="- Version 1.0.0" color="#e0e0e0" />
          </div>
          <div class="HLayout">
            <DisplayText value="Designed and built by " color="#e0e0e0" />
            <Link value="Lionel Wu." href="https://www.linkedin.com/in/enhao-wu-18a596138" />
            <DisplayText value="Licensed under the" color="#e0e0e0" />
            <Link value="MIT License." href="https://github.com/enw860/vueApp" />
          </div>
        </div>
      </div>
    </div>
