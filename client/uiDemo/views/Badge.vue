<template>
  <div class="BadgeDemo">
    <ControlDemoTemplate>
      <div slot="overview">
        <p>The badge is a sub-component of avatar. It is used to representing if there is an update for a user/events.</p>
      </div>
...
import Badge from "../../basic_controls/vue/infomational/Badge.vue";

import DisplayText from "../../basic_controls/vue/infomational/DisplayText";
...
import Number from "../../basic_controls/vue/inputs/Number.vue";
